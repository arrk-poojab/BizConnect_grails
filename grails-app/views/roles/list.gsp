			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="authority" title="${message(code: 'roles.authority.label', default: 'Authority')}" />
				...
				<g:each in="${rolesInstanceList}" status="i" var="rolesInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${rolesInstance.id}">${fieldValue(bean: rolesInstance, field: "authority")}</g:link></td>
