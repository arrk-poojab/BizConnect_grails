	...
	<body>
		...
		<div id="show-roles" class="content scaffold-show" role="main">
			...
			<ol class="property-list roles">
				...
				<g:if test="${rolesInstance?.authority}">
				<li class="fieldcontain">
					<span id="authority-label" class="property-label"><g:message code="roles.authority.label" default="Authority" /></span>
					
						<span class="property-value" aria-labelledby="authority-label"><g:fieldValue bean="${rolesInstance}" field="authority"/></span>
